...
<div class="container py-5" style="height: auto; color: black">
    <div class="row p-5 my-5 justify-content-center  bg-white  rounded ">
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-rose pull-right">{{ __('Save Changes') }}</button>
